...
namespace Vitol.Enzo.CRM.Infrastructure
{
    ...
    {
        //SMS TEMPLATE
        string smsT2, smsT4, smsT5, smsT6, smsT8, smsT9, smsT10 = string.Empty;
